 ...
 */
function createDocumentId(documentGroupId: string, dbDocumentId: string): Uint8Array {
 ...
 */
function getSealApproveTxPayload(packageId: string, documentGroupId: string, documentId: Uint8Array) {
  return {
    kind: 'moveCall',
 ...
 */
function createDocumentGroupTxPayload(packageId: string, name: string, dbId: string) {
  return {
    kind: 'moveCall',
 ...
 */
function addUserToDocumentGroupTxPayload(
  packageId: string, 
 ...
 */
function removeUserFromDocumentGroupTxPayload(
  packageId: string, 
  documentGroupId: string, 
  adminCapId: string, 
  userAddress: string
