...
import { extendSession } from '@/utils/sessionTimeoutManager';
...
const SessionTimeoutModal: React.FC<SessionTimeoutModalProps> = ({
  ...
  const [timeRemaining, setTimeRemaining] = useState<number>(remainingTime);
  const [countdown, setCountdown] = useState<number>(Math.floor(remainingTime / 1000));
